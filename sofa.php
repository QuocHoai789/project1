	...
	<div id="khung">
		...
		<div>
			...
			<div id="sp">
				...
				<br/>
				<p  id="pt" >
					<a href="http://localhost:81/do_an_web/sofa.php?gr=<?php echo $gr-1; ?>"> <?php if($gr>1){echo '&laquo';} ?></a>
					<?php for($i=$dau;$i<=$cuoi;$i++){?>
						<a href="http://localhost:81/do_an_web/sofa.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
					<?php } ?>
					<a href="http://localhost:81/do_an_web/sofa.php?gr=<?php echo $gr+1; ?>"><?php if($gr<$tsn){echo '&raquo';} ?></a> 
				</p>
			</div>
		</div>
