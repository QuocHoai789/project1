	...
	<div id="khung">
		...
		<div>
			...
			<div id="sp">
				...
				$sosp=8;
				$sotrang=2;
				$sql3="select * from sanpham where MaLoai='1'";
				...
				$query="select * from sanpham where MaLoai='1' limit $vt,$sosp  ";
				...
				<br/>
				<p  id="pt" >
					<a href="http://localhost:8080/do_an_web1/sofa.php?gr=<?php echo $gr-1; ?>"> <?php if($gr>1){echo '&laquo';} ?></a>
					<?php for($i=$dau;$i<=$cuoi;$i++){?>
						<a href="http://localhost:8080/do_an_web1/sofa.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
					<?php } ?>
					<a href="http://localhost:8080/do_an_web1/sofa.php?gr=<?php echo $gr+1; ?>"><?php if($gr<$tsn){echo '&raquo';} ?></a> 
				</p>
			</div>
		</div>
