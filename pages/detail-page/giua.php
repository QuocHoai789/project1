...
<head>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="../css/giua.css">
	...
	<div id="sanpham">
		...
		<div class="sanpham1"><p> Sofa gỗ phòng khách</p></div>
			...
			for($i=1;$i<=5;$i++) { $d=mysqli_fetch_array($kq); ?>
				...
				<div class="text-sp-bc" onclick="return alert('Đã thêm vào giỏ hàng');"><a class="btn btn-info btn-md" href="detail-page/xuly1.php?MaSp=<?php echo $d['MaSp']; ?>&soluong=1" >Thêm vào giỏ hàng</a></div>
				</div>
		...
		<div class="sanpham1"><p> Tượng gỗ cao cấp</p></div>
			...
			for($i=1;$i<=5;$i++) { $d2=mysqli_fetch_array($kq2); ?>
				...
				<div class="text-sp-bc" onclick="return alert('Đã thêm vào giỏ hàng');"><a class="btn btn-info btn-md" href="detail-page/xuly1.php?MaSp=<?php echo $d2['MaSp']; ?>&soluong=1" >Thêm vào giỏ hàng</a></div>
				</div>
		...
		<div class="sanpham1"><p> Giường ngủ gỗ</p></div>
			...
			for($i=1;$i<=5;$i++) { $d3=mysqli_fetch_array($kq3); ?>
				...
				<div class="text-sp-bc" onclick="return alert('Đã thêm vào giỏ hàng');"><a href="detail-page/xuly1.php?MaSp=<?php echo $d3['MaSp']; ?>&soluong=1" class="btn btn-info btn-md">Thêm vào giỏ hàng</a></div>
				</div>
					
					<p class="tensp"><a href="http://localhost:8080/do_an_web1/pages/chitietsanpham.php?MaSp=<?php echo $d3['MaSp']; ?>" ><?php echo $d3['TenSp']; ?></a></p>
