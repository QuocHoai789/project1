...
<head>
	<title>Sofa</title>
	<link rel="stylesheet" type="text/css" href="../css/loaisanpham.css">
	...
	<div id="khung">
		...
		<div>
			...
			<div id="sp">
				...
				<br/>
				<p  id="pt" >
					<a href="http://localhost:8080/do_an_web1/pages/loaisanpham.php?MaLoai=<?php echo $MaLoai; ?>&gr=<?php echo $gr-1; ?><?php if(isset($sapxep)) echo '&sapxep='.$sapxep; ?>"> <?php if($gr>1){echo '&laquo';} ?></a>
					<?php for($i=$dau;$i<=$cuoi;$i++){?>
						<a  href="http://localhost:8080/do_an_web1/pages/loaisanpham.php?MaLoai=<?php echo $MaLoai; ?>&page=<?php echo $i; ?><?php if(isset($sapxep)) echo '&sapxep='.$sapxep; ?>"><?php if(isset($_GET['page'])&& $_GET['page']==$i){echo "<span style='color:red'>".$i."</span>";}else echo $i; ?></a>
					<?php } ?>
					<a href="http://localhost:8080/do_an_web1/pages/loaisanpham.php?MaLoai=<?php echo $MaLoai; ?>&gr=<?php echo $gr+1; ?><?php if(isset($sapxep)) echo '&sapxep='.$sapxep; ?>"><?php if($gr<$tsn){echo '&raquo';} ?></a> 
				</p>
			</div>
		</div>
