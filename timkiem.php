			...
			<div id="sp">
				...
				if( isset($_GET['search']) && !empty($_GET['search']) ){
					...
					if($sl==0){
						...
						<br/>
						<p  id="pt" >
							<a href="http://localhost:81/do_an_web1/timkiem.php?search=<?php echo $search; ?>&gr=<?php echo $gr-1; ?><?php if(isset($sapxep)) echo '&sapxep='.$sapxep; ?>">
								<?php if($gr>1){echo '&laquo';} ?>
								
							</a>
							<?php for($i=$dau;$i<=$cuoi;$i++){?>
								<a href="http://localhost:81/do_an_web1/timkiem.php?search=<?php echo $search.'&page=';?><?php echo $i; ?><?php if(isset($sapxep)) echo '&sapxep='.$sapxep; ?>">
									<?php echo $i; ?>
