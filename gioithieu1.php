...
<html>
<head>
	<link rel="stylesheet" type="text/css" href="gioithieu1.css">
	<title>gt1</title>
</head>
<body>
<?php
  echo'<div class="gioithieu1a">
 		...
 		<div id="gioithieu2a">
                ...
                <p>*Email*:<a href="#" >toletrunghieu@gmail.com</a> hoặc <a href="#">nguyenquochoai789@gmail.com</a></p><br/>
                <img width="1200px" height="400px" src="hinhanh/cty.jpg"><br/>
                <span style="padding-left: 450px;font-weight: bold;">Ảnh chụp xưởng làm việc của công ty</span>
